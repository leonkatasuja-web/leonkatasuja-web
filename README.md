...
### Я — начинающий инженер по тестированию, стремящийся к качеству.

- Прошел интенсивный курс, где работал в условиях, максимально приближенных к реальной разработке: от ведения задач в Яндекс.Трекере до тестирования на Stage-окружении.
- Научился автоматизации фронта,для ускорения процессов тестирования (Python + Cypress).
- Моя цель не просто находить баги, а оценивать качество продукта и вносить корректикровки по его улучшению
- Ценю командную работу, открыт к коммуникации с разработчиками, аналитиками и менеджером продукта. Стремлюсь влиться в команду, где можно совместно решать сложные задачи, вносить вклад в проект и профессионально расти.
...
<div>
  ...
  <img src="https://avatars.mds.yandex.net/i?id=f90a19a95da093f16e91ac03477c399c_l-12532262-images-thumbs&n=13" title="DBeaver" alt="DBeaver" width="40" height="40"/>&nbsp
</div>
...
## 🎒 Образование
[<img src="/Sertifikat.png" width="280px" hspace="10px" alt="Диплом»">](https://raw.githubusercontent.com/leonkatasuja-web/leonkatasuja-web/refs/heads/main/Sertifikat.png)

<br>
<br>

## 🤝 Контакт
[![Email](https://img.shields.io/badge/Email-3b5998?style=flat-square&logo=Mail.Ru&logoColor=white)](mailto:luzhkov-leha@mail.ru)
[![Telegram Badge](https://img.shields.io/badge/-Telegram-0088cc?style=flat-square&logo=Telegram&logoColor=white)](https://t.me/Forkorschtain)
